...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="index.css?9">
    <script
  ...
  <body>
    ...
    <div id="Sidenav0" class="sidenav">
        <div id="Searchbar">
            <input type="text" id="myInput" spellcheck="true" onkeyup="myFunction()" placeholder="Search for names..">
      
            <ul id="myUL">
              <li><a href="#">Photo de Rodrigue</a></li>
              <li><a href="#">Photo de Kevin</a></li>
            </ul>
          </div>
    ...
    <main>
      <div id="slider">
        <figure>
          <img src="assets/carousel1.jpg" alt="l'espace1">
          <img src="assets/carousel2.jpg" alt="l'espace2">
          <img src="assets/carousel3.jpg" alt="l'espace3">
          <img src="assets/carousel4.png" alt="l'espace4">
          <img src="assets/carousel5.png" alt="l'espace5">
        </figure>
      </div>
      <section id="section1">
        <p id="reallylong" class="Longtext">
          <img src="assets/lolo_k.png" alt="Cute cat" class="leftfloat">
      ...
      suscipit pulvinar. Nulla sollicitudin. Fusce varius, ligula non tempus aliquam, nunc 
        turpis ullamcorper nibh, in tempus sapien eros vitae ligula. Pellentesque rhoncus nunc 
        et augue. Integer id felis. Curabitur aliquet pellentesque diam. Integer quis metus 
...
adipiscing nisl, ac euismod nibh nisl eu lectus. Fusce vulputate sem at sapien. Vivamus leo.
 ...
 nulla in justo. Suspendisse cursus rutrum augue. Nulla tincidunt tincidunt mi. Curabitur iaculis,
  lorem vel rhoncus faucibus, felis magna fermentum augue, et ultricies lacus lorem varius purus. Curabitur eu amet.
      ...
      <div class="ui-widget">
        <label for="tags">JQuery Search: </label>
        <input id="tags">
      </div>

      <!-- Workshop Carousel Bootstrap-->
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img class="d-block w-100" src="./assets/images/audi_a1.jpg" alt="First slide">
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src="./assets/images/vw_passat.jpg" alt="Second slide">
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src="./assets/images/mz_cx5.jpg" alt="Third slide">
          </div>
        </div>
